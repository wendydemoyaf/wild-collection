  ...
  return (
    <main className="min-h-screen text-white overflow-hidden bg-[radial-gradient(circle_at_78%_38%,rgba(212,20,90,0.28),transparent_28%),radial-gradient(circle_at_85%_70%,rgba(240,76,139,0.22),transparent_32%),radial-gradient(circle_at_55%_60%,rgba(182,106,80,0.18),transparent_35%),linear-gradient(135deg,#161214,#2A101B,#080506)]">
      <header className="fixed top-0 left-0 w-full z-50 px-5 md:px-10 py-5 md:py-6 flex justify-between text-[10px] md:text-xs tracking-[0.25em] md:tracking-[0.35em] text-[#F7E9DF] bg-[#161214]/60 backdrop-blur-md border-b border-[#D4145A]/20">
        <Link href="/" className="transition-all duration-500 hover:text-[#F04C8B] hover:drop-shadow-[0_0_10px_rgba(240,76,139,0.9)]">
          WILD COLLECTION
        </Link>

        <Link href="/femenino" className="transition-all duration-500 hover:text-[#F04C8B] hover:drop-shadow-[0_0_10px_rgba(240,76,139,0.9)]">
          VOLVER
        </Link>
      </header>

      <section className="min-h-screen grid grid-cols-1 md:grid-cols-[0.95fr_1.05fr] pt-24 md:pt-24 px-6 md:px-20 gap-10 md:gap-6 items-center">
        <div className="max-w-2xl">
          ...
          <div className="bg-black/25 border border-[#D4145A]/20 rounded-2xl px-5 md:px-6 py-4 md:py-3 mb-10 md:mb-12 backdrop-blur-sm w-full">
            <p className="text-sm md:text-base leading-relaxed text-[#F7E9DF]/85">
              Una dulzura adulta, sensual y adictiva. Caramelo cálido, benjuí y
              almizcle blanco se mezclan en una fragancia femenina, sofisticada
              y envolvente.
            </p>
          </div>
        ...
        <div className="relative flex justify-center items-center group w-[320px] md:w-[360px] mx-auto mb-14 md:mb-10 md:mt-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700">
            <div className="w-full h-[60vh] md:h-[70vh] bg-black/40 border border-[#D4145A]/20 rounded-3xl backdrop-blur-xl px-7 md:px-10 py-10 md:py-14 flex flex-col justify-center gap-2 shadow-[0_0_80px_rgba(212,20,90,0.24)]">
