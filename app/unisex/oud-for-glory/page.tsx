      ...
      <section className="min-h-screen grid grid-cols-1 md:grid-cols-[0.95fr_1.05fr] pt-24 px-6 md:px-20 gap-10 md:gap-6 items-center">
        <div className="max-w-xl">
          ...
          <p className="italic text-black/60 mb-6">
            Intenso, misterioso y absolutamente poderoso.
          </p>

          <p className="text-base leading-relaxed text-black/70 mb-6">
            Como entrar a un espacio donde el silencio, el lujo y el misterio
            dominan todo. Una fragancia oriental intensa que transmite poder
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10 mb-6">
            <div className="pt-4">
              ...
              <p className="text-sm">Oud · Intenso</p>
            </div>
            ...
            <div className="pt-4">
              ...
              <div className="w-14 h-[1px] bg-black/30 mb-3"></div>
              <p className="text-sm">Noche · Poder</p>
            </div>
            ...
            <div className="pt-4">
              ...
              <div className="w-14 h-[1px] bg-black/30 mb-3"></div>
              <p className="text-sm">Misterioso · Dominante</p>
            </div>
          </div>
