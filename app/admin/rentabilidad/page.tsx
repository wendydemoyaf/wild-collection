...
export default function RentabilidadPage() {
  ...
  return <AdminShell><main className={styles.dashboard}>
    <div className={styles.inner}>
      <section className={styles.intro}><div><p className={styles.eyebrow}>Wild Ads Control</p><h1>Rentabilidad,<br /><em>con atribución real.</em></h1></div><div><p>Solo se muestran pedidos cuando exista una relación explícita con la campaña. Este módulo no infiere ni asigna atribuciones.</p><small>Última actualización: {timestamp(data!.updated_at)}</small></div></section>
